...
const FIELD_LABELS: Record<string, string> = {
    ...
    url_comercial: "URL comercial",
    campana: "Campaña",
    fecha_de_visita: "Fecha de visita",
    hora_de_visita: "Hora de visita",
};
