...
export const DEFAULT_REPORT_COLUMN_FIELDS: Record<ReportTabId, string[]> = {
    overview: COMPLETE_DETAIL_FIELDS,
    funnel: COMPLETE_DETAIL_FIELDS,
    operational: COMPLETE_DETAIL_FIELDS,
    followup: COMPLETE_DETAIL_FIELDS,
    performance: COMPLETE_DETAIL_FIELDS,
    trends: COMPLETE_DETAIL_FIELDS,
    scoring: COMPLETE_DETAIL_FIELDS,
    chats: COMPLETE_DETAIL_FIELDS,
};
